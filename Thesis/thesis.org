...
*** TWO Photophysics history                                       :ignore:
    ...
    :END:
*** TWO Why the study of light is important
    :LOGBOOK:
    ...
    :END:
** TWO Qualitaive Overview of Non-Adiabatic Dynamics [3/3]
   #+begin_src latex
   \section{Qualitative Overview of Non-Adiabatic Dynamics}
   #+end_src
*** TWO Qualitative explanation of what we are trying to model with Non-Adiabatic Dynamics [4/4] :ignore:
    #+begin_src latex
...
***** TWO Must go beyon the Born-Oppenheimer
     ...
     :END:
***** TWO Mean-Field vs MDQT [2/2]
****** TWO Diagram showing mean-field and surface hopping
       #+begin_src latex
       \noindent
       \begin{multiFigure} 
	 ...
	 \label{fig:surfaceHoppingVsMeanField}
       \end{multiFigure}
       #+end_src
****** TWO Explanation of the Mean-Field vs Surface Hopping 
       :LOGBOOK:
	 ...
	 - The average potential of the two tully PE will not equal the potential energy of ehrenfest
       :END:
***** TWO Explanation of Non-Adiabatic Transition [2/2]
****** TWO Figure Showing a Slow Approach and Fast Approach for crossing
       #+begin_src latex
       \noindent
...
**** ONE Overview
     ...
     - Note taken on [2021-02-02 Tue 19:13] \\
       ...
       - A common approximation is to replace the overlap matrix S with the uni matrix and only treat the valence electrons quantum mechanically. \cite{christensen2016semiempirical}
...
**** ONE AM1
    ...
    - Note taken on [2021-02-02 Tue 18:43] \\
      - The Austin Model 1 (AM1) is the hamiltonian that we used throughout this paper.
      - It is a modified neglect of differential diatomic overlap
