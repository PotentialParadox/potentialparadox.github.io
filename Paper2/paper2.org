...
#+CAPTION: Average potential energy during dynamics at 300K for PPV_{3}. Vacuum (No Trivial) is dynamics ran without trivial crossings. label:fig:ppv3-potential 
[[./Images/potential_energies/ppv3.png]]

#+CAPTION: Average potential energy during dynamics at 300K for PPV_{3}-NO_{2}. label:fig:ppv3-no2-potential 
