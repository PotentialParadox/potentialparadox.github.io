...
#+BIBLIOGRAPHY: paper2
* Introduction (621 needed)
** Introduction to non-adiabatic dynamics
*** Thesis statement
...
*** Described 1 situation where adiabatic dynamics fails
These situations occur frequently within processes of interest to photochemistry and photophysics. 
*** Describe a 2nd situation where adiabatic dynamics fails
...
*** Discribe a situtation where QM/MM would be useful for NA-dynamics
** Description of NEXMD
*** What it does
*** Who designed it.
*** How it works (Non-Mathematical)?
*** Who has used it?
** Description of AMBER
*** What it does?
**** Classical dynamics for large systems
**** Capable of perform QM/MM using the SANDER packag
*** Who designed it.
*** How it works (Non-Mathematical)?
*** Who has used it?
** Combining QM w/ NA-ESMD
*** Who has already done this
*** What has it been used for
*** Describe what my implementation would be useful for.
** Describe the layout of the paper
...
The matrix elements of this electron Hamiltonian are
...
The time-dependent Shrodinger equation can then be written as
...
The BLA for both PPV_3 and PPV_{3}-NO_{2} in
