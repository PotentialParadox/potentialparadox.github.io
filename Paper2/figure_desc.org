...
#+CAPTION: Torsional angles averaged over the ensemble of trajectories for S_m for PPV_{3}-NO_{2} in vacuum, a classical methanol box, and a classical methanol box with the closest 5 methanols included in the QM calculation.
